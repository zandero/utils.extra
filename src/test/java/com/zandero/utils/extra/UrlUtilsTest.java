...
class UrlUtilsTest {
    ...
    void testResolveDomainName() {
		...
		assertNull(UrlUtils.resolveDomain(null));
		assertNull(UrlUtils.resolveDomain(""));
		assertNull(UrlUtils.resolveDomain(" "));
    }
    ...
    void resolveUrlParts() {
        ...
        assertEquals(80, Objects.requireNonNull(UrlUtils.resolvePort("http://test.com:80")).intValue());
        ...
        assertEquals(80, Objects.requireNonNull(UrlUtils.resolvePort("https://www.zandero.co")).intValue());
    }
